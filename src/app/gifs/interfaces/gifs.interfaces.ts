// To parse this data:
//
//   import { Convert, SearchResonse } from "./file";
//
//   const searchResonse = Convert.toSearchResonse(json);
//
...
export class Convert {
  public static toSearchResonse(json: string): SearchResonse {
      return cast(JSON.parse(json), r("SearchResonse"));
  }

  public static searchResonseToJson(value: SearchResonse): string {
      return JSON.stringify(uncast(value, r("SearchResonse")), null, 2);
  }
}
